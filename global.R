#
dataname <- list.dirs(recursive = F)|>basename()
dataname <- setdiff(dataname, c("www",".git",".Rproj.user"))
coordinates <- c("UMAP","tSNE")
defaultcellmeta <- c("orig.ident","seurat_clusters")
...
# Panel sizes 
pList = c("300px", "500px", "700px")
names(pList) = c("Small", "Medium", "Large") 
pList2 = c("300px", "500px", "700px") 
names(pList2) = c("Small", "Medium", "Large") 
pList3 = c("300px", "500px", "700px") 
